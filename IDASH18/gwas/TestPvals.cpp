...
void TestPvals::trueNLGDiteration(double** zData, double*& wData, double*& vData, long factorDim, long sampleDim, double gamma, double eta) {
...
void TestPvals::calculateAUC(double** zData, double* wData, long factorDim, long sampleDim, double& correctness, double& auc) {
    cout << "w:";
    for (long i = 0; i < factorDim; ++i) {
        cout << wData[i] << ",";
    }
