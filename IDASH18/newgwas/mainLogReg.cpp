...
int main(int argc, char **argv) {
    ...
    TestHELRPvals::new_testFastHELogReg(zScore, pVals, yData, xData, sData, factorDim, sampleDim, nsnp, snptag, "LogRegResult/HE_Pvals.txt");    //! 0.00523846
    ...
    //TestLRPvals::testLogRegGD(zScore, pVals, yData, xData, sData, factorDim, sampleDim, nsnp, trainsigdeg, testsigdeg, numIter, gammaUp, gammaDown, "LogRegResult/Plain_Pvals_deg3.txt"); //! plain comp
