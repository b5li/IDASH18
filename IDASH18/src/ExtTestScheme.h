...
public:
    ...
    static void testProdDecompKS(long logN,  long L, long logp, long logSlots);
    
    static void testDecompRotate(long logN,  long L, long logRotSlots, long RotSlots, long logp, long logSlots);
